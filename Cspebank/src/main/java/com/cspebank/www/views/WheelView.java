...
import com.cspebank.www.ui.adapter.wheel.WheelViewAdapter;
import com.cspebank.www.utils.wheel.WheelChangedListener;
import com.cspebank.www.utils.wheel.WheelClickedListener;
import com.cspebank.www.utils.wheel.WheelItemsRange;
import com.cspebank.www.utils.wheel.WheelRecycle;
import com.cspebank.www.utils.wheel.WheelScrollListener;
import com.cspebank.www.utils.wheel.WheelScroller;
...
public class WheelView extends View {
	...
	/** Top and bottom shadows colors 渐变的颜色值、*/
	...
	// Recycle
	private WheelRecycle recycle = new WheelRecycle(this);//设置轮动时view的切换

	// Listeners
	private List<WheelChangedListener> changingListeners = new LinkedList<WheelChangedListener>();
	private List<WheelScrollListener> scrollingListeners = new LinkedList<WheelScrollListener>();
	private List<WheelClickedListener> clickingListeners = new LinkedList<WheelClickedListener>();
	 ...
	 *            the listener
	 */
	public void addChangingListener(WheelChangedListener listener) {
	 ...
	 *            the listener
	 */
	public void removeChangingListener(WheelChangedListener listener) {
	...
	protected void notifyChangingListeners(int oldValue, int newValue) {
		for (WheelChangedListener listener : changingListeners) {
	 ...
	 *            the listener
	 */
	public void addClickingListener(WheelClickedListener listener) {
	 ...
	 *            the listener
	 */
	public void removeClickingListener(WheelClickedListener listener) {
	...
	protected void notifyClickListenersAboutClick(int item) {
		for (WheelClickedListener listener : clickingListeners) {
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(
					R.drawable.wheel_val); //设置滚轮中间线条，可以设置改变颜色,
		}

		if (topShadow == null) {
			topShadow = new GradientDrawable(Orientation.TOP_BOTTOM,
					SHADOWS_COLORS);//顶部渐变的颜色值
		}
		...
		setBackgroundResource(R.drawable.wheel_bg);//设置滚轮的背景颜色
	}
...
//		int height = (int) (3 * getItemHeight());//渐变阴影的高度
		int height = 0;		//渐变阴影的高度
