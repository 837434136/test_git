...
public class CalendarUtil {
    ...
    public String toString() {
        ...
        if (com.cspebank.www.utils.StringUtils.isNullOrEmpty(message)) {
            String solarMsg = new com.cspebank.www.utils.SolarTermsUtil(mCurrenCalendar).getSolartermsMsg();
            //判断当前日期是否为节气
            if (!com.cspebank.www.utils.StringUtils.isNullOrEmpty(solarMsg)) {
                message = solarMsg;
            } else {
                /**
                 * 判断当前日期是否为公历节日
                 */
                String gremessage = new com.cspebank.www.utils.GregorianUtil(mCurrenCalendar).getGremessage();
                if (!com.cspebank.www.utils.StringUtils.isNullOrEmpty(gremessage)) {
                    message = gremessage;
                } else if (mLuchDay == 1) {
