...
package com.cspebank.www.utils.wheel;

import android.view.View;
import android.widget.LinearLayout;

import com.cspebank.www.views.WheelView;
...
public class WheelRecycle {
	...
	/**
	 * Constructor
	 * @param scheduleWheelView the wheel view
	 */
	public WheelRecycle(WheelView scheduleWheelView) {
		this.wheel = scheduleWheelView;
	}
	 ...
	 */
	public int recycleItems(LinearLayout layout, int firstItem, com.cspebank.www.utils.wheel.WheelItemsRange range) {
		int index = firstItem;
