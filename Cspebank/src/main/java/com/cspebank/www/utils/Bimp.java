...
public class Bimp {
	...
	public static List<String> mbimppath = new ArrayList<String>();
	public static int TempImg = 6;  //可选图片最大值
	...
	public static Bitmap revitionImageSize(String path) throws IOException {
		...
		// 当机型为三星时图片翻转
		bitmap = com.cspebank.www.utils.Photo.photoAdapter(path, bitmap);
